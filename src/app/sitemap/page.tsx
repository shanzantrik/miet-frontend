  ...
  const sitemapData = [
    ...
    },
    {
      ...
      links: [
        ...
        { name: "Courses", href: "/marketplace/courses", description: "Educational courses and programs" },
        { name: "Books", href: "/marketplace/books", description: "Educational books and literature" },
        { name: "Apps & Tools", href: "/marketplace/apps", description: "Digital tools and applications" },
        { name: "Gadgets", href: "/marketplace/gadgets", description: "Assistive technology devices" }
      ]
    },
    {
      title: "Learning",
